    ...
    if(i<1){
        button.remove();
        parent.parentElement.innerHTML+='<div class="new"><div><label type="text" class="duree1"> Durée de la location  : </label><input type="text" class="duree" placeholder="Quelle est la durée de la location estimée ?" required></div><div><label type="text" class="cond1"> Conditions de location : </label><input type="text" class="cond" placeholder="Quelles sont les conditions de location exigées ?" required class="quest2"></div></div>'
        ok=1;
